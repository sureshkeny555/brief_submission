...
import "./Layout.scss";
import ReceiverHeader from "../Components/Receiver flow/ReceiverHeader/ReceiverHeader";
import ReceiverSidebar from "../Components/Receiver flow/ReceiverSidebar/ReceiverSidebar";
import { useDispatch, useSelector } from "react-redux";
import { logoutUser } from "../store/features/authorization";
...
const ReceiverLayout = () => {
  ...
  return (
    <div className="layout">
      {!isLoginPage && <ReceiverHeader />}

      <div className="layout-body">
        {!isLoginPage && <ReceiverSidebar />}
