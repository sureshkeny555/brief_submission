...
function ApprovalPageShowAll({ onClose }) {
  ...
  const handleBackClick = () => {
    navigate("/receiverlayout/statusbrief");
  };
  ...
  const handleContinue = () => {
    setShowModal(false);
    // navigate("/receiverlayout/statusbrief");
    window.location.href = "/receiverlayout/statusbrief";
  };
    ...
    <div className="approval-page-today-dl">
      ...
      <div className="form-container-approval-modal-tdy-dl">
        ...
        <div className="form-row-am-tdy-dl">
          ...
          <div className="form-column-am-tdy-dl">
            <label>City</label>
            <input type="text" value={brief?.city} readOnly />
          </div>
        ...
        <>
          ...
          <div className="text-area-group">
            <label>Key information area TG</label>
            <textarea
              name="research_tg"
              placeholder="Target group"
              autoComplete="off"
            ...
            {brief.file_path && (
              ...
              >
                ...
                >
                  ...
                  <span>{brief.creator_file || "File"}</span>
                </a>
              </div>
            )}
          </div>
              ...
              <form onSubmit={handleAcceptSubmit} className="form-grid">
                ...
                <div className="form-groups">
                  ...
                  <input
                    ...
                    onChange={handleInputChange}
                    placeholder="Agency finalization"
                    readOnly
                    required
                  />
                </div>
...
export default ApprovalPageShowAll;
