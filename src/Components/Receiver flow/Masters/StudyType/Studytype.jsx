  ...
  return (
    <div className="study-body">
      ...
      <div className="study-content">
        ...
        {/* <div className="study-formbody"></div> */}
        <div className="study-formfoot">
          <button className="study-previous">Previous</button>
          <div>Pagination</div>
          <button className="study-next">Next</button>
        </div>
      </div>
