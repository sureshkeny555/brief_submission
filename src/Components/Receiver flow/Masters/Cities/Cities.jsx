...
function Cities() {
  ...
  return (
    <div className="citi-body">
      <div className="citi-header">
      ...
      <div className="citi-content">
        <div className="citi-formhead">
          <table className="">
            <thead className="">
              <tr>
                <th>Cities</th>
        ...
        {/* <div className="citi-formbody"></div> */}
        <div className="citi-formfoot">
          <button className="citi-previous">Previous</button>
          <div>Pagination</div>
          <button className="citi-next">Next</button>
        </div>
      </div>
